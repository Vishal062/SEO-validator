...
export default function LandingPage() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative">
        ...
        <div className="flex flex-col items-center justify-center text-xs text-black">
          <span className="flex items-center gap-1 mb-1">
            ...
            <a
              ...
              className="text-black hover:underline hover:text-blue-800 transition pointer-events-auto select-auto"
